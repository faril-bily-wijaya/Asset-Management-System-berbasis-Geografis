...
import { Network, X, Shield, AlertTriangle, Activity, Zap, MapPin } from 'lucide-react';
...
export default function NetworkDashboard({ locationsData, rawLocationsData, onClose, onNavigateToSite }) {
  // Compute site health data
  ...
  // Device type distribution per district
  ...
  // Power infrastructure radar (averaged by role)
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-white dark:bg-slate-900 w-full max-w-7xl h-full max-h-[92vh] rounded-3xl shadow-2xl flex flex-col overflow-hidden"
      >
        {/* Header */}
        <div className="p-5 md:p-6 border-b border-slate-200 dark:border-slate-800 flex justify-between items-start bg-gradient-to-r from-slate-50 to-indigo-50/50 dark:from-slate-800/50 dark:to-indigo-900/20">
          <div>
        ...
        {/* Content */}
        <div className="flex-1 overflow-auto p-4 md:p-6 bg-slate-50/50 dark:bg-slate-900 space-y-6">
          {/* Overview Cards */}
