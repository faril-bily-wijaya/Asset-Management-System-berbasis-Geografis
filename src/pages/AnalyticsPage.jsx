...
export default function AnalyticsPage() {
  ...
  const statusPieData = [
    { name: 'Operational', value: mapData.stats.operational, color: '#10b981' },
    { name: 'Non-Operational', value: mapData.stats.nonOperational, color: '#ef4444' }
  ];

  const topLocations = [...mapData.locationsData]
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto h-full flex flex-col relative pt-4">
        <div className="mb-6 flex justify-between items-start">
          <div>
            ...
            <p className="text-sm md:text-base text-slate-500 dark:text-slate-400 mt-1.5 font-medium">Berdasarkan filter pencarian saat ini ({mapData.stats.total} Perangkat)</p>
          </div>
        ...
        <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 flex flex-col">
            ...
            <div className="flex-1 min-h-[400px]">
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  <Pie data={statusPieData} cx="50%" cy="50%" innerRadius={80} outerRadius={140} paddingAngle={5} dataKey="value" stroke="none">
